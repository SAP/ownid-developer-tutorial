...
When FIDO2 is not supported, key pair is created and stored encrypted in the mobile device browser storage. In this scenario OwnID notifies the user it is recommended to have the phone locked.
